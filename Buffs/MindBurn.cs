...
namespace AlchemistNPCReborn.Buffs
{
	public class MindBurn : ModBuff
	{
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "Сжигание разума");
        ...
        public override void Update(Player player, ref int buffIndex)
        {
			...
			player.GetModPlayer<MindBurnDebuffPlayer>().lifeRegenDebuff= true;
		}
	}

	public class MindBurnDebuffPlayer : ModPlayer
	{
