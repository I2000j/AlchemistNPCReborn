...
namespace AlchemistNPCReborn.Items
{
    public class AlchemistGlobalItem : GlobalItem
    {
        ...
        public override bool? UseItem(Item item, Player player)
        {
            ...
            if (item.type == 1991 || item.type == 3183)
            {
                for (int v = 0; v < 200; ++v)
                {
                    ...
                    {
                        if (AlchemistNPCReborn.modConfiguration.CatchNPC)
                        {
        ...
        {
            //SBMW:Vanilla
            string KingSlime = Language.GetTextValue("Mods.AlchemistNPCReborn.KingSlime");
            string EyeofCthulhu = Language.GetTextValue("Mods.AlchemistNPCReborn.EyeofCthulhu");
            string EaterOfWorlds = Language.GetTextValue("Mods.AlchemistNPCReborn.EaterOfWorlds");
            string BrainOfCthulhu = Language.GetTextValue("Mods.AlchemistNPCReborn.BrainOfCthulhu");
            string QueenBee = Language.GetTextValue("Mods.AlchemistNPCReborn.QueenBee");
            string Skeletron = Language.GetTextValue("Mods.AlchemistNPCReborn.Skeletron");
            string Deerclops = Language.GetTextValue("Mods.AlchemistNPCReborn.Deerclops");
            string WallOfFlesh = Language.GetTextValue("Mods.AlchemistNPCReborn.WallOfFlesh");
            string QueenSlime = Language.GetTextValue("Mods.AlchemistNPCReborn.QueenSlime");
            string Destroyer = Language.GetTextValue("Mods.AlchemistNPCReborn.Destroyer");
            string Twins = Language.GetTextValue("Mods.AlchemistNPCReborn.Twins");
            string SkeletronPrime = Language.GetTextValue("Mods.AlchemistNPCReborn.SkeletronPrime");
            string Plantera = Language.GetTextValue("Mods.AlchemistNPCReborn.Plantera");
            string EmpressOfLight = Language.GetTextValue("Mods.AlchemistNPCReborn.EmpressOfLight");
            string Golem = Language.GetTextValue("Mods.AlchemistNPCReborn.Golem");
            string Betsy = Language.GetTextValue("Mods.AlchemistNPCReborn.Betsy");
            string DukeFishron = Language.GetTextValue("Mods.AlchemistNPCReborn.DukeFishron");
            string MoonLord = Language.GetTextValue("Mods.AlchemistNPCReborn.MoonLord");

            //SBMW:CalamityMod
            string DesertScourge = Language.GetTextValue("Mods.AlchemistNPCReborn.DesertScourge");
            string Crabulon = Language.GetTextValue("Mods.AlchemistNPCReborn.Crabulon");
            string HiveMind = Language.GetTextValue("Mods.AlchemistNPCReborn.HiveMind");
            string Perforator = Language.GetTextValue("Mods.AlchemistNPCReborn.Perforator");
            string SlimeGod = Language.GetTextValue("Mods.AlchemistNPCReborn.SlimeGod");
            string Cryogen = Language.GetTextValue("Mods.AlchemistNPCReborn.Cryogen");
            string BrimstoneElemental = Language.GetTextValue("Mods.AlchemistNPCReborn.BrimstoneElemental");
            string AquaticScourge = Language.GetTextValue("Mods.AlchemistNPCReborn.AquaticScourge");
            string Calamitas = Language.GetTextValue("Mods.AlchemistNPCReborn.Calamitas");
            string AstrageldonSlime = Language.GetTextValue("Mods.AlchemistNPCReborn.AstrageldonSlime");
            string AstrumDeus = Language.GetTextValue("Mods.AlchemistNPCReborn.AstrumDeus");
            string Leviathan = Language.GetTextValue("Mods.AlchemistNPCReborn.Leviathan");
            string PlaguebringerGoliath = Language.GetTextValue("Mods.AlchemistNPCReborn.PlaguebringerGoliath");
            string Ravager = Language.GetTextValue("Mods.AlchemistNPCReborn.Ravager");
            string Providence = Language.GetTextValue("Mods.AlchemistNPCReborn.Providence");
            string StormWeaver = Language.GetTextValue("Mods.AlchemistNPCReborn.StormWeaver");
            string CeaselessVoid = Language.GetTextValue("Mods.AlchemistNPCReborn.CeaselessVoid");
            string Signus = Language.GetTextValue("Mods.AlchemistNPCReborn.Signus");
            string Polterghast = Language.GetTextValue("Mods.AlchemistNPCReborn.Polterghast");
            string OldDuke = Language.GetTextValue("Mods.AlchemistNPCReborn.OldDuke");
            string DevourerofGods = Language.GetTextValue("Mods.AlchemistNPCReborn.DevourerofGods");
            string Bumblebirb = Language.GetTextValue("Mods.AlchemistNPCReborn.Bumblebirb");
            string Yharon = Language.GetTextValue("Mods.AlchemistNPCReborn.Yharon");
            string ExoMechs = Language.GetTextValue("Mods.AlchemistNPCReborn.ExoMechs");
            string SupremeCalamitas = Language.GetTextValue("Mods.AlchemistNPCReborn.SupremeCalamitas");

            //SBMW:ThoriumMod
            string DarkMage = Language.GetTextValue("Mods.AlchemistNPCReborn.DarkMage");
            string Ogre = Language.GetTextValue("Mods.AlchemistNPCReborn.Ogre");
            string ThunderBird = Language.GetTextValue("Mods.AlchemistNPCReborn.ThunderBird");
            string QueenJellyfish = Language.GetTextValue("Mods.AlchemistNPCReborn.QueenJellyfish");
            string CountEcho = Language.GetTextValue("Mods.AlchemistNPCReborn.CountEcho");
            string GraniteEnergyStorm = Language.GetTextValue("Mods.AlchemistNPCReborn.GraniteEnergyStorm");
            string TheBuriedChampion = Language.GetTextValue("Mods.AlchemistNPCReborn.TheBuriedChampion");
            string TheStarScouter = Language.GetTextValue("Mods.AlchemistNPCReborn.TheStarScouter");
            string BoreanStrider = Language.GetTextValue("Mods.AlchemistNPCReborn.BoreanStrider");
            string CoznixTheFallenBeholder = Language.GetTextValue("Mods.AlchemistNPCReborn.CoznixTheFallenBeholder");
            string TheLich = Language.GetTextValue("Mods.AlchemistNPCReborn.TheLich");
            string AbyssionTheForgottenOne = Language.GetTextValue("Mods.AlchemistNPCReborn.AbyssionTheForgottenOne");
            string TheRagnarok = Language.GetTextValue("Mods.AlchemistNPCReborn.TheRagnarok");

            //ElementsAwoken
            string Wasteland = Language.GetTextValue("Mods.AlchemistNPCReborn.Wasteland");
            string Infernace = Language.GetTextValue("Mods.AlchemistNPCReborn.Infernace");
            string ScourgeFighter = Language.GetTextValue("Mods.AlchemistNPCReborn.ScourgeFighter");
            string Regaroth = Language.GetTextValue("Mods.AlchemistNPCReborn.Regaroth");
            string TheCelestials = Language.GetTextValue("Mods.AlchemistNPCReborn.TheCelestials");
            string Permafrost = Language.GetTextValue("Mods.AlchemistNPCReborn.Permafrost");
            string Obsidious = Language.GetTextValue("Mods.AlchemistNPCReborn.Obsidious");
            string Aqueous = Language.GetTextValue("Mods.AlchemistNPCReborn.Aqueous");
            string TempleKeepers = Language.GetTextValue("Mods.AlchemistNPCReborn.TempleKeepers");
            string Guardian = Language.GetTextValue("Mods.AlchemistNPCReborn.Guardian");
            string Volcanox = Language.GetTextValue("Mods.AlchemistNPCReborn.Volcanox");
            string VoidLevi = Language.GetTextValue("Mods.AlchemistNPCReborn.VoidLevi");
            string Azana = Language.GetTextValue("Mods.AlchemistNPCReborn.Azana");
            string Ancients = Language.GetTextValue("Mods.AlchemistNPCReborn.Ancients");

            //Redemption
            string KingChicken = Language.GetTextValue("Mods.AlchemistNPCReborn.KingChicken");
            string ThornBane = Language.GetTextValue("Mods.AlchemistNPCReborn.ThornBane");
            string TheKeeper = Language.GetTextValue("Mods.AlchemistNPCReborn.TheKeeper");
            string XenoCrystal = Language.GetTextValue("Mods.AlchemistNPCReborn.XenoCrystal");
            string IEye = Language.GetTextValue("Mods.AlchemistNPCReborn.IEye");
            string KingSlayer = Language.GetTextValue("Mods.AlchemistNPCReborn.KingSlayer");
            string V1 = Language.GetTextValue("Mods.AlchemistNPCReborn.V1");
            string V2 = Language.GetTextValue("Mods.AlchemistNPCReborn.V2");
            string V3 = Language.GetTextValue("Mods.AlchemistNPCReborn.V3");
            string PZ = Language.GetTextValue("Mods.AlchemistNPCReborn.PZ");
            string ThornRematch = Language.GetTextValue("Mods.AlchemistNPCReborn.ThornRematch");
            string Nebuleus = Language.GetTextValue("Mods.AlchemistNPCReborn.Nebuleus");

            //SacredTools
            string Decree = Language.GetTextValue("Mods.AlchemistNPCReborn.Decree");
            string FlamingPumpkin = Language.GetTextValue("Mods.AlchemistNPCReborn.FlamingPumpkin");
            string Jensen = Language.GetTextValue("Mods.AlchemistNPCReborn.Jensen");
            string Araneas = Language.GetTextValue("Mods.AlchemistNPCReborn.Araneas");
            string Raynare = Language.GetTextValue("Mods.AlchemistNPCReborn.Raynare");
            string Primordia = Language.GetTextValue("Mods.AlchemistNPCReborn.Primordia");
            string Abaddon = Language.GetTextValue("Mods.AlchemistNPCReborn.Abaddon");
            string Araghur = Language.GetTextValue("Mods.AlchemistNPCReborn.Araghur");
            string Lunarians = Language.GetTextValue("Mods.AlchemistNPCReborn.Lunarians");
            string Challenger = Language.GetTextValue("Mods.AlchemistNPCReborn.Challenger");
            string Spookboi = Language.GetTextValue("Mods.AlchemistNPCReborn.Spookboi");

            //SpiritMod
            string Scarabeus = Language.GetTextValue("Mods.AlchemistNPCReborn.Scarabeus");
            string Bane = Language.GetTextValue("Mods.AlchemistNPCReborn.Bane");
            string Flier = Language.GetTextValue("Mods.AlchemistNPCReborn.Flier");
            string Raider = Language.GetTextValue("Mods.AlchemistNPCReborn.Raider");
            string Infernon = Language.GetTextValue("Mods.AlchemistNPCReborn.Infernon");
            string Dusking = Language.GetTextValue("Mods.AlchemistNPCReborn.Dusking");
            string EtherialUmbra = Language.GetTextValue("Mods.AlchemistNPCReborn.EtherialUmbra");
            string IlluminantMaster = Language.GetTextValue("Mods.AlchemistNPCReborn.IlluminantMaster");
            string Atlas = Language.GetTextValue("Mods.AlchemistNPCReborn.Atlas");
            string Overseer = Language.GetTextValue("Mods.AlchemistNPCReborn.Overseer");

            //Enigma
            string Sharkron = Language.GetTextValue("Mods.AlchemistNPCReborn.Sharkron");
            string Hypothema = Language.GetTextValue("Mods.AlchemistNPCReborn.Hypothema");
            string Ragnar = Language.GetTextValue("Mods.AlchemistNPCReborn.Ragnar");
            string AnDio = Language.GetTextValue("Mods.AlchemistNPCReborn.AnDio");
            string Annihilator = Language.GetTextValue("Mods.AlchemistNPCReborn.Annihilator");
            string Slybertron = Language.GetTextValue("Mods.AlchemistNPCReborn.Slybertron");
            string SteamTrain = Language.GetTextValue("Mods.AlchemistNPCReborn.SteamTrain");

            //pinky
            string SunlightTrader = Language.GetTextValue("Mods.AlchemistNPCReborn.SunlightTrader");
            string THOFC = Language.GetTextValue("Mods.AlchemistNPCReborn.THOFC");
            string MythrilSlime = Language.GetTextValue("Mods.AlchemistNPCReborn.MythrilSlime");
            string Valdaris = Language.GetTextValue("Mods.AlchemistNPCReborn.Valdaris");
            string Gatekeeper = Language.GetTextValue("Mods.AlchemistNPCReborn.Gatekeeper");

            //AAMod
            string Monarch = Language.GetTextValue("Mods.AlchemistNPCReborn.Monarch");
            string Grips = Language.GetTextValue("Mods.AlchemistNPCReborn.Grips");
            string Broodmother = Language.GetTextValue("Mods.AlchemistNPCReborn.Broodmother");
            string Hydra = Language.GetTextValue("Mods.AlchemistNPCReborn.Hydra");
            string Serpent = Language.GetTextValue("Mods.AlchemistNPCReborn.Serpent");
            string Djinn = Language.GetTextValue("Mods.AlchemistNPCReborn.Djinn");
            string Retriever = Language.GetTextValue("Mods.AlchemistNPCReborn.Retriever");
            string RaiderU = Language.GetTextValue("Mods.AlchemistNPCReborn.RaiderU");
            string Orthrus = Language.GetTextValue("Mods.AlchemistNPCReborn.Orthrus");
            string EFish = Language.GetTextValue("Mods.AlchemistNPCReborn.EFish");
            string Nightcrawler = Language.GetTextValue("Mods.AlchemistNPCReborn.Nightcrawler");
            string Daybringer = Language.GetTextValue("Mods.AlchemistNPCReborn.Daybringer");
            string Yamata = Language.GetTextValue("Mods.AlchemistNPCReborn.Yamata");
            string Akuma = Language.GetTextValue("Mods.AlchemistNPCReborn.Akuma");
            string Zero = Language.GetTextValue("Mods.AlchemistNPCReborn.Zero");
            string Shen = Language.GetTextValue("Mods.AlchemistNPCReborn.Shen");
            string ShenGrips = Language.GetTextValue("Mods.AlchemistNPCReborn.ShenGrips");
