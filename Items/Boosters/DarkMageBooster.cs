...
namespace AlchemistNPCReborn.Items.Boosters
{
	class DarkMageBooster : ModItem
	{
        ...
        {
			if (player.GetModPlayer<AlchemistNPCRebornPlayer>().DarkMageBooster == 0)
			{
				player.GetModPlayer<AlchemistNPCRebornPlayer>().DarkMageBooster = 1;
				return true;
			}
			if (player.GetModPlayer<AlchemistNPCRebornPlayer>().DarkMageBooster == 1)
			{
				player.GetModPlayer<AlchemistNPCRebornPlayer>().DarkMageBooster = 0;
				return true;
			}
