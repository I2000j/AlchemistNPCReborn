...
namespace AlchemistNPCReborn.Items.Boosters
{
	class EyeOfCthulhuBooster : ModItem
	{
        ...
        {
			if (player.GetModPlayer<AlchemistNPCRebornPlayer>().EyeOfCthulhuBooster == 0)
			{
				player.GetModPlayer<AlchemistNPCRebornPlayer>().EyeOfCthulhuBooster = 1;
				return true;
			}
			if (player.GetModPlayer<AlchemistNPCRebornPlayer>().EyeOfCthulhuBooster == 1)
			{
				player.GetModPlayer<AlchemistNPCRebornPlayer>().EyeOfCthulhuBooster = 0;
				return true;
			}
