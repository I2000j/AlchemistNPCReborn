...
namespace AlchemistNPCReborn.Items.Boosters
{
	class IceGolemBooster : ModItem
	{
        ...
        {
			if (player.GetModPlayer<AlchemistNPCRebornPlayer>().IceGolemBooster == 0)
			{
				player.GetModPlayer<AlchemistNPCRebornPlayer>().IceGolemBooster = 1;
				return true;
			}
			if (player.GetModPlayer<AlchemistNPCRebornPlayer>().IceGolemBooster == 1)
			{
				player.GetModPlayer<AlchemistNPCRebornPlayer>().IceGolemBooster = 0;
				return true;
			}
