...
namespace AlchemistNPCReborn.Items.Boosters
{
	class KingSlimeBooster : ModItem
	{
        ...
        {
			if (player.GetModPlayer<AlchemistNPCRebornPlayer>().KingSlimeBooster == 0)
			{
				player.GetModPlayer<AlchemistNPCRebornPlayer>().KingSlimeBooster = 1;
				return true;
			}
			if (player.GetModPlayer<AlchemistNPCRebornPlayer>().KingSlimeBooster == 1)
			{
				player.GetModPlayer<AlchemistNPCRebornPlayer>().KingSlimeBooster = 0;
				return true;
			}
