...
namespace AlchemistNPCReborn.Items.Boosters
{
	class PlanteraBooster : ModItem
	{
        ...
        {
			if (player.GetModPlayer<AlchemistNPCRebornPlayer>().PlanteraBooster == 0)
			{
				player.GetModPlayer<AlchemistNPCRebornPlayer>().PlanteraBooster = 1;
				return true;
			}
			if (player.GetModPlayer<AlchemistNPCRebornPlayer>().PlanteraBooster == 1)
			{
				player.GetModPlayer<AlchemistNPCRebornPlayer>().PlanteraBooster = 0;
				return true;
			}
