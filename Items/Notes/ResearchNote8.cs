...
And as the last part, we need to give them a body. I think  that [c/00FF00:fire sentry] from the Elders army could work.");
			DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "Запись исследования №8");
            Tooltip.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), @"Однажды, я побывала в довольно интересном мире. Это была гигантская лаборатория. Сердцем лаборатории был робот по имени ''ГЛаДОС''.
...
А в качестве последней части, нам необходимо дать ей тело. Думаю, что [c/00FF00:Огненная турель] Древних нам подойдёт.");
			DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "研究笔记 #8");
			Tooltip.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), @"曾经, 我在一个有趣的世界. 那是个巨大的实验室. 这个实验室的核心是机器人, 她的名字是“GlaDos”(G姐).
