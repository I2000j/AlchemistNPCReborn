...
namespace AlchemistNPCReborn.Items.Notes
{
	public class TornNote8 : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "Изорванная записка #8");
            Tooltip.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "'Я нашла один древний свиток с весьма ценной информацией...\nТам сказано что Голем хранит внутри своего тела лабораторный журнал Ведьмы, известный как Фуаран.\nОн способен значительно увеличить магический потенциал любого мага, слабого или сильного - нет значения...\nЭтот журнал может быть важным опытом для любого. Хотела бы я узнать, найдётся ли он когда-нибудь...'\nЗдесь ещё есть что-то важное, но вы не можете это прочесть. Не без других частей.\nВозможно, Ювелир сможет помочь.");

            DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "破损的笔记 #8");
            Tooltip.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "'我发现了一个古老的卷轴，里面有很多有价值的信息..." +
