...
namespace AlchemistNPCReborn.Items.Notes
{
	public class SecretNote3 : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "Тайная записка 3");
            Tooltip.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "''В одном древнем свитке я обнаружила довольно... неприятную информацию.\nТам говорилось о... Розовом Парне? Понятия не имею, кто это.\nВ общем, если ты экипируешь сет его брони в качестве основной во время битвы с Лунным Лордом...\nТо ты можешь получить нечто уникальное.\nНо будь осторожен с этой вещью!\nОна может привлечь внимание ОЧЕНЬ опасного существа.''\nЗдесь ещё есть что-то важное, но вы не можете это прочесть. Не без других частей.\nВозможно, Ювелир сможет помочь.");
			DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "秘密笔记 #3");
			Tooltip.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "''在一幅古代卷轴中, 我发现了一个... 让人不愉快的消息."
