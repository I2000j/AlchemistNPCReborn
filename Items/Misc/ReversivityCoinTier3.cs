...
namespace AlchemistNPCReborn.Items.Misc
{
    public class ReversivityCoinTier3 : ModItem
    {
        public override void SetStaticDefaults()
        {
			...
			DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "Монета Реверсии Третьего Уровня");
            ...
            DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "逆转硬币 T-3");
