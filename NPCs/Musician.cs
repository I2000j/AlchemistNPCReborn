    ...
    public class Musician : ModNPC
    {
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCReborn.Bestiary.Musician")
            });
        }
        ...
        {
            if (NPC.downedBoss3 && AlchemistNPCReborn.modConfiguration.MusicianSpawn)
            {
                return true;
            }
            return false;
        ...
        {                                       //NPC names
            string Beethoven = Language.GetTextValue("Mods.AlchemistNPCReborn.Beethoven");
            string Bach = Language.GetTextValue("Mods.AlchemistNPCReborn.Bach");
            string Johan = Language.GetTextValue("Mods.AlchemistNPCReborn.Johan");
            string Edison = Language.GetTextValue("Mods.AlchemistNPCReborn.Edison");
            string Scott = Language.GetTextValue("Mods.AlchemistNPCReborn.Scott");
            string Lloyd = Language.GetTextValue("Mods.AlchemistNPCReborn.Lloyd");
            string Gamma = Language.GetTextValue("Mods.AlchemistNPCReborn.Gamma");
        ...
        {
            string EntryM1 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM1");
            string EntryM2 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM2");
            string EntryM3 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM3");
            string EntryM4 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM4");
            string EntryM5 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM5");
            string EntryM6 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM6");
            string EntryM7 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM7");
            string EntryM8 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM8");
            string EntryM9 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM9");
            string EntryM10 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM10");
            string EntryM11 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM11");
            string EntryM12 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM12");
            string EntryM13 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM13");
            string EntryM14 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM14");
            string EntryM15 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM15");
            string EntryM16 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM16");
            string EntryM17 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM17");
            string EntryM18 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM18");
            string EntryM19 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM19");
            string EntryM20 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM20");
            string EntryM21 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM21");
            string EntryM22 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryM22");
            string Gamma = Language.GetTextValue("Mods.AlchemistNPCReborn.Gamma");
        ...
        {
            string Shop2 = Language.GetTextValue("Mods.AlchemistNPCReborn.Shop2");
            string Shop3 = Language.GetTextValue("Mods.AlchemistNPCReborn.Shop3");
