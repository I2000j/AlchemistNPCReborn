    ...
    public class YoungBrewer : ModNPC
    {
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCReborn.Bestiary.YoungBrewer")
            });
        }
        ...
        {
            if (Main.hardMode && AlchemistNPCReborn.modConfiguration.YoungBrewerSpawn)
            {
        ...
        {                                       //NPC names
            string Harold = Language.GetTextValue("Mods.AlchemistNPCReborn.Harold");
            string Charles = Language.GetTextValue("Mods.AlchemistNPCReborn.Charles");
            string Monty = Language.GetTextValue("Mods.AlchemistNPCReborn.Monty");
            string Lucas = Language.GetTextValue("Mods.AlchemistNPCReborn.Lucas");
            string Porky = Language.GetTextValue("Mods.AlchemistNPCReborn.Porky");
            string Leeland = Language.GetTextValue("Mods.AlchemistNPCReborn.Leeland");
            string Atreus = Language.GetTextValue("Mods.AlchemistNPCReborn.Atreus");
        ...
        {                                           //npc chat
            string Entry1 = Language.GetTextValue("Mods.AlchemistNPCReborn.Entry1");
            string Entry2 = Language.GetTextValue("Mods.AlchemistNPCReborn.Entry2");
            string Entry3 = Language.GetTextValue("Mods.AlchemistNPCReborn.Entry3");
            string Entry4 = Language.GetTextValue("Mods.AlchemistNPCReborn.Entry4");
            string Entry5 = Language.GetTextValue("Mods.AlchemistNPCReborn.Entry5");
            string Entry6 = Language.GetTextValue("Mods.AlchemistNPCReborn.Entry6");
            string Entry7 = Language.GetTextValue("Mods.AlchemistNPCReborn.Entry7");
