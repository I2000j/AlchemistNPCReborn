...
namespace AlchemistNPCReborn.NPCs
{
    ...
    public class Alchemist : ModNPC
    {
        ...
        public override string Texture
        {
            get
            {
                return "AlchemistNPCReborn/NPCs/Alchemist";
            }
        }
        ...
        public override void SetStaticDefaults()
        {
            ...
            LocalizationLoader.AddTranslation(text);
			text = LocalizationLoader.CreateTranslation("BrewElixir");
            text.SetDefault("Brew Life Elixir");
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "炼制仙丹");
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "Сварить Эликсир Жизни");
            LocalizationLoader.AddTranslation(text);
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCReborn.Bestiary.Alchemist")
            });
        }
        ...
        {
            if (NPC.downedBoss1 && AlchemistNPCReborn.modConfiguration.AlchemistSpawn)
            {
                return true;
            }
            return false;
        ...
        {                                       //NPC names
            string Edward = Language.GetTextValue("Mods.AlchemistNPCReborn.Edward");
            string Severus = Language.GetTextValue("Mods.AlchemistNPCReborn.Severus");
            string Horace = Language.GetTextValue("Mods.AlchemistNPCReborn.Horace");
            string Tilyorn = Language.GetTextValue("Mods.AlchemistNPCReborn.Tilyorn");
            string Nicolas = Language.GetTextValue("Mods.AlchemistNPCReborn.Nicolas");
            string Gregg = Language.GetTextValue("Mods.AlchemistNPCReborn.Gregg");
        ...
        {                                           //npc chat
            string EntryA1 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA1");
            string EntryA2 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA2");
            string EntryA3 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA3");
            string EntryA4 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA4");
            string EntryA5 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA5");
            string EntryA6 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA6");
            string EntryA7 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA7");
            string EntryA8 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA8");
            string EntryA9 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA9");
            string EntryA10 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA10");
            string EntryA11 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA11");
            string EntryA12 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA12");
            string EntryA13 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA13");
            string EntryA14 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA14");
            string EntryA15 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA15");
            string EntryA16 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA16");
            string EntryA17 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA17");
            string EntryA18 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA18");
            string EntryA19 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA19");
            string EntryA20 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA20");
            string EntryA21 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA21");
            string EntryA22 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA22");
            string EntryA23 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA23");
            string EntryA24 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA24");
            string EntryA25 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA25");
            string EntryA26 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA26");
            string EntryA27 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryA27");
        ...
        {
            string PlantsShop = Language.GetTextValue("Mods.AlchemistNPCReborn.PlantsShop");
            string GetCharm = Language.GetTextValue("Mods.AlchemistNPCReborn.GetCharm");
			string BrewElixir = Language.GetTextValue("Mods.AlchemistNPCReborn.BrewElixir");
			string Gregg = Language.GetTextValue("Mods.AlchemistNPCReborn.Gregg");
