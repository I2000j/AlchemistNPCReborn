...
namespace AlchemistNPCReborn.NPCs
{
    ...
    public class Architect : ModNPC
    {
        ...
        public override string Texture
        {
            get
            {
                return "AlchemistNPCReborn/NPCs/Architect";
            }
        }
        // Possibly removed
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "Архитектор");
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCReborn.Bestiary.Architect")
            });
        }
        ...
        {
            if (numTownNPCs >= 3 && AlchemistNPCReborn.modConfiguration.ArchitectSpawn)
            {
                return true;
            }
            return false;
        ...
        {                                       //NPC names
            string Joe = Language.GetTextValue("Mods.AlchemistNPCReborn.Joe");
            string Mark = Language.GetTextValue("Mods.AlchemistNPCReborn.Mark");
            string Walter = Language.GetTextValue("Mods.AlchemistNPCReborn.Walter");
            string Archer = Language.GetTextValue("Mods.AlchemistNPCReborn.Archer");
            string Frido = Language.GetTextValue("Mods.AlchemistNPCReborn.Frido");
            string Li = Language.GetTextValue("Mods.AlchemistNPCReborn.Li");
        ...
        {                                          //npc chat
            string A1 = Language.GetTextValue("Mods.AlchemistNPCReborn.A1");
            string A2 = Language.GetTextValue("Mods.AlchemistNPCReborn.A2");
            string A3 = Language.GetTextValue("Mods.AlchemistNPCReborn.A3");
            string A4 = Language.GetTextValue("Mods.AlchemistNPCReborn.A4");
            string A5 = Language.GetTextValue("Mods.AlchemistNPCReborn.A5");
            string A6 = Language.GetTextValue("Mods.AlchemistNPCReborn.A6");
            string A7 = Language.GetTextValue("Mods.AlchemistNPCReborn.A7");
            string A8 = Language.GetTextValue("Mods.AlchemistNPCReborn.A8");
            string A9 = Language.GetTextValue("Mods.AlchemistNPCReborn.A9");
            string A10 = Language.GetTextValue("Mods.AlchemistNPCReborn.A10");
            string A11 = Language.GetTextValue("Mods.AlchemistNPCReborn.A11");
            string A12 = Language.GetTextValue("Mods.AlchemistNPCReborn.A12");
            string A13 = Language.GetTextValue("Mods.AlchemistNPCReborn.A13");
            string A14 = Language.GetTextValue("Mods.AlchemistNPCReborn.A14");
            string A15 = Language.GetTextValue("Mods.AlchemistNPCReborn.A15");
            string A16 = Language.GetTextValue("Mods.AlchemistNPCReborn.A16");
            string A17 = Language.GetTextValue("Mods.AlchemistNPCReborn.A17");
            string A18 = Language.GetTextValue("Mods.AlchemistNPCReborn.A18");
            string A19 = Language.GetTextValue("Mods.AlchemistNPCReborn.A19");
            string A20 = Language.GetTextValue("Mods.AlchemistNPCReborn.A20");
            string A21 = Language.GetTextValue("Mods.AlchemistNPCReborn.A21");
            string A22 = Language.GetTextValue("Mods.AlchemistNPCReborn.A22");
        ...
        {
            string AS1 = Language.GetTextValue("Mods.AlchemistNPCReborn.AS1");
            string AS2 = Language.GetTextValue("Mods.AlchemistNPCReborn.AS2");
            string AS3 = Language.GetTextValue("Mods.AlchemistNPCReborn.AS3");
            string AS4 = Language.GetTextValue("Mods.AlchemistNPCReborn.AS4");
            string AS5 = Language.GetTextValue("Mods.AlchemistNPCReborn.AS5");
            string AS6 = Language.GetTextValue("Mods.AlchemistNPCReborn.AS6");
            string AS7 = Language.GetTextValue("Mods.AlchemistNPCReborn.AS7");
            string AS8 = Language.GetTextValue("Mods.AlchemistNPCReborn.AS8");
            string AS9 = Language.GetTextValue("Mods.AlchemistNPCReborn.AS9");
            string AS10 = Language.GetTextValue("Mods.AlchemistNPCReborn.AS10");
