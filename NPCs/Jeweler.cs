    ...
    public class Jeweler : ModNPC
    {
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCReborn.Bestiary.Jeweler")
            });
        }
        ...
        {
            if (NPC.downedBoss1 && AlchemistNPCReborn.modConfiguration.JewelerSpawn)
            {
                return true;
            }
            return false;
        ...
        {                                       //NPC names
            string Carl = Language.GetTextValue("Mods.AlchemistNPCReborn.Carl");
            string John = Language.GetTextValue("Mods.AlchemistNPCReborn.John");
            string JanMare = Language.GetTextValue("Mods.AlchemistNPCReborn.JanMare");
            string LuiFransua = Language.GetTextValue("Mods.AlchemistNPCReborn.LuiFransua");
            string Daniel = Language.GetTextValue("Mods.AlchemistNPCReborn.Daniel");
            string Charley = Language.GetTextValue("Mods.AlchemistNPCReborn.Charley");
        ...
        {                                           //npc chat
            string EntryJ1 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryJ1");
            string EntryJ2 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryJ2");
            string EntryJ3 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryJ3");
            string EntryJ4 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryJ4");
            string EntryJ5 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryJ5");
            string EntryJ6 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryJ6");
            string EntryJ7 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryJ7");
            string EntryJ8 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryJ8");
            string EntryJ9 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryJ9");
            string EntryJ10 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryJ10");
        ...
        {
            string ArenaShop = Language.GetTextValue("Mods.AlchemistNPCReborn.ArenaShop");
			string Combine = Language.GetTextValue("Mods.AlchemistNPCReborn.Combine");
