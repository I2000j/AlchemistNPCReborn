...
namespace AlchemistNPCReborn.NPCs
{
    ...
    public class Operator : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            text = LocalizationLoader.CreateTranslation("EGOShop");
            text.SetDefault("EGO Equipment Shop");
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Russian), "Магазин Э.П.О.С.");
            text.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "EGO 装备商店");
            LocalizationLoader.AddTranslation(text);
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCReborn.Bestiary.Operator")
            });
        }
        ...
        {
            string Angela = Language.GetTextValue("Mods.AlchemistNPCReborn.Angela");
            string Carmen = Language.GetTextValue("Mods.AlchemistNPCReborn.Carmen");
        ...
        {                                           //npc chat
            string EntryO1 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO1");
            string EntryO2 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO2");
            string EntryO3 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO3");
            string EntryO4 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO4");
            string EntryO5 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO5");
            string EntryO6 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO6");
            string EntryO7 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO7");
            string EntryO8 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO8");
            string EntryO9 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO9");
            string EntryO10 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO10");
            string EntryO11 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO11");
            string EntryO12 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO12");
            string EntryO13 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO13");
            string EntryO14 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO14");
            string EntryO15 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO15");
            string EntryO16 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO16");
            string EntryO17 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO17");
            string EntryO18 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO18");
            string EntryO19 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO19");
            string EntryO20 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO20");
            string EntryO21 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO21");
            string EntryO22 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO22");
            string EntryO23 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO23");
            string EntryO24 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO24");
            string EntryO25 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO25");
            string EntryO26 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO26");
            string EntryO27 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO27");
            string EntryO28 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO28");
            string EntryO29 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO29");
            string EntryO30 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO30");
            string EntryO31 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO31");
            string EntryO32 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO32");
            string EntryO33 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO33");
            string EntryO34 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO34");
            string EntryO35 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO35");
            string EntryO36 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryO36");
        ...
        public override void SetChatButtons(ref string button, ref string button2)
        {
            ...
            string ModdedTreasureBagsShop = Language.GetTextValue("Mods.AlchemistNPCReborn.ModdedTreasureBagsShop");
		...
		*/
            ...
            if (Shop3)
            {
                ...
                if (NPC.downedBoss3 && Main.expertMode)
                {
                    ...
                    if (NPC.downedSlimeKing)
                    {
				        ...
				        shop.item[nextSlot].shopSpecialCurrency = AlchemistNPCReborn.ReversivityCoinTier1ID;
                        nextSlot++;
                    }
                    ...
                    if (NPC.downedBoss2)
                    {
                        ...
                        //shop.item[nextSlot].shopCustomPrice = 500000;
                        shop.item[nextSlot].shopCustomPrice = new int?(14);
				        shop.item[nextSlot].shopSpecialCurrency = AlchemistNPCReborn.ReversivityCoinTier1ID;
                        nextSlot++;
				    ...
				    shop.item[nextSlot].shopSpecialCurrency = AlchemistNPCReborn.ReversivityCoinTier2ID;
                    nextSlot++;
				...
				*/
                ...
                if (NPC.downedFishron && Main.expertMode)
                {
                    ...
                    //shop.item[nextSlot].shopCustomPrice = 3500000;
                    shop.item[nextSlot].shopCustomPrice = new int?(11);
				    shop.item[nextSlot].shopSpecialCurrency = AlchemistNPCReborn.ReversivityCoinTier4ID;
                    nextSlot++;
                }
                ...
                if (NPC.downedMoonlord && Main.expertMode)
                {
                    ...
                    shop.item[nextSlot].shopCustomPrice = new int?(26);
				    shop.item[nextSlot].shopSpecialCurrency = AlchemistNPCReborn.ReversivityCoinTier4ID;
                    nextSlot++;
                }
            }
            ...
            if (Shop4)
            {
                ...
                if (Calamity != null)
				{
                    if (NPC.downedBoss3 && Main.expertMode)
                    {
                    	...
                    	{
                    		addModItemToT1CShop(Calamity, "DesertScourgeBag", 6, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "crabulon"))
                    	{
                    		addModItemToT1CShop(Calamity, "CrabulonBag", 9, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "hive mind") || (bool)Calamity.Call("Downed", "perforators"))
                    	{
                    		addModItemToT1CShop(Calamity, "HiveMindBag", 16, ref shop, ref nextSlot);
                    		addModItemToT1CShop(Calamity, "PerforatorBag", 16, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "slime god"))
                    	{
                    		addModItemToT2CShop(Calamity, "SlimeGodBag", 6, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "cryogen"))
                    	{
                    		addModItemToT2CShop(Calamity, "CryogenBag", 10, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "brimstone elemental"))
                    	{
                    		if (!(bool)Calamity.Call("Downed", "providence"))
                    			addModItemToT3CShop(Calamity, "BrimstoneWaifuBag", 14, ref shop, ref nextSlot);
                    		else
                    			addModItemToT4CShop(Calamity, "BrimstoneWaifuBag", 12, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "aquatic scourge"))
                    	{
                    		addModItemToT3CShop(Calamity, "AquaticScourgeBag", 14, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "calamitas doppelganger"))
                    	{
                    		if (!(bool)Calamity.Call("Downed", "providence"))
                    			addModItemToT3CShop(Calamity, "CalamitasBag", 20, ref shop, ref nextSlot);
                    		else
                    			addModItemToT4CShop(Calamity, "CalamitasBag", 20, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "leviathan"))
                    	{
                    		addModItemToT3CShop(Calamity, "LeviathanBag", 23, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "astrum aureus"))
                    	{
                            if(!(bool)Calamity.Call("Downed", "providence"))
                    		    addModItemToT3CShop(Calamity, "AstrageldonBag", 30, ref shop, ref nextSlot);
                            else
                                addModItemToT4CShop(Calamity, "AstrageldonBag", 30, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "astrum deus"))
                    	{
                    		addModItemToT4CShop(Calamity, "AstrumDeusBag", 10, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "plaguebringer goliath"))
                    	{
                    		addModItemToT4CShop(Calamity, "PlaguebringerGoliathBag", 15, ref shop, ref nextSlot); 
                    	}
                    	if ((bool)Calamity.Call("Downed", "ravager"))
                    	{
                    		addModItemToT4CShop(Calamity, "RavagerBag", 20, ref shop, ref nextSlot); 
                    	}
                    	if ((bool)Calamity.Call("Downed", "bumblebirb"))
                    	{
                    		addModItemToT5CShop(Calamity, "BumblebirbBag", 10, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "providence"))
                    	{
                    		addModItemToT5CShop(Calamity, "ProvidenceBag", 14, ref shop, ref nextSlot);
                    	}
                        if ((bool)Calamity.Call("Downed", "stormweaver"))
                        {
                    		addModItemToT6CShop(Calamity, "StormWeaverBag", 3, ref shop, ref nextSlot);
                        }
                        if ((bool)Calamity.Call("Downed", "ceaselessvoid"))
                        {
                    		addModItemToT6CShop(Calamity, "CeaselessVoidBag", 3, ref shop, ref nextSlot);
                        }
                        if ((bool)Calamity.Call("Downed", "signus"))
                        {
                    		addModItemToT6CShop(Calamity, "SignusBag", 3, ref shop, ref nextSlot);
                        }
                    	if ((bool)Calamity.Call("Downed", "polterghast"))
                    	{
                    		addModItemToT6CShop(Calamity, "PolterghastBag", 10, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "old duke"))
                    	{
                    		addModItemToT6CShop(Calamity, "OldDukeBag", 17, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "dog"))
                    	{
                    		addModItemToT6CShop(Calamity, "DevourerofGodsBag", 26, ref shop, ref nextSlot);
                    	}
                    	if ((bool)Calamity.Call("Downed", "yharon"))
                    	{
                    		addModItemToT6CShop(Calamity, "YharonBag", 30, ref shop, ref nextSlot);
                    	}
                        if ((bool)Calamity.Call("Downed", "exomechs"))
                        {
                    		addModItemToT6CShop(Calamity, "DraedonTreasureBag", 37, ref shop, ref nextSlot);
                        }
                        if ((bool)Calamity.Call("Downed", "supremecalamitas"))
                        {
                    		addModItemToT6CShop(Calamity, "SCalBag", 45, ref shop, ref nextSlot);
                        }
                    }
                }
                // IMPLEMENT WHEN WEAKREFERENCES FIXED
        ...
        private void addModItemToT1CShop(Mod mod, String itemName, int price, ref Chest shop, ref int nextSlot)
        {
            if (mod.TryFind<ModItem>(itemName, out ModItem currItem))
                shop.item[nextSlot].SetDefaults(currItem.Type);
        ...
        private void addModItemToT2CShop(Mod mod, String itemName, int price, ref Chest shop, ref int nextSlot)
        {
            if (mod.TryFind<ModItem>(itemName, out ModItem currItem))
                shop.item[nextSlot].SetDefaults(currItem.Type);
            shop.item[nextSlot].shopCustomPrice = new int?(price);
        ...
        private void addModItemToT3CShop(Mod mod, String itemName, int price, ref Chest shop, ref int nextSlot)
        {
            if (mod.TryFind<ModItem>(itemName, out ModItem currItem))
                shop.item[nextSlot].SetDefaults(currItem.Type);
            shop.item[nextSlot].shopCustomPrice = new int?(price);
        ...
        private void addModItemToT4CShop(Mod mod, String itemName, int price, ref Chest shop, ref int nextSlot)
        {
            if (mod.TryFind<ModItem>(itemName, out ModItem currItem))
                shop.item[nextSlot].SetDefaults(currItem.Type);
            shop.item[nextSlot].shopCustomPrice = new int?(price);
        ...
        private void addModItemToT5CShop(Mod mod, String itemName, int price, ref Chest shop, ref int nextSlot)
        {
            if (mod.TryFind<ModItem>(itemName, out ModItem currItem))
                shop.item[nextSlot].SetDefaults(currItem.Type);
            shop.item[nextSlot].shopCustomPrice = new int?(price);
			shop.item[nextSlot].shopSpecialCurrency = AlchemistNPCReborn.ReversivityCoinTier5ID;
            nextSlot++;
        }
        private void addModItemToT6CShop(Mod mod, String itemName, int price, ref Chest shop, ref int nextSlot)
        {
            if (mod.TryFind<ModItem>(itemName, out ModItem currItem))
                shop.item[nextSlot].SetDefaults(currItem.Type);
            shop.item[nextSlot].shopCustomPrice = new int?(price);
			shop.item[nextSlot].shopSpecialCurrency = AlchemistNPCReborn.ReversivityCoinTier6ID;
            nextSlot++;
        }
    }
}