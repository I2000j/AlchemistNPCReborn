...
namespace AlchemistNPCReborn.NPCs
{
	...
	public class OtherworldlyPortal : ModNPC
	{
		...
		{
			string barrierStabilized = Language.GetTextValue("Mods.AlchemistNPCReborn.barrierStabilized");
			Main.NewText(barrierStabilized, 55, 55, 255);
			NPC.Transform(ModContent.NPCType<NPCs.Explorer>());
			return Language.GetTextValue("Mods.AlchemistNPCReborn.portalOpen");
		}

		public override List<string> SetNPCNameList()
        {
            string PortalName = Language.GetTextValue("Mods.AlchemistNPCReborn.PortalName");
