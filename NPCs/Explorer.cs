...
namespace AlchemistNPCReborn.NPCs
{
	...
	public class Explorer : ModNPC
	{
		...
		public override string Texture
		{
			get
			{
				return "AlchemistNPCReborn/NPCs/Explorer";
			}
		}
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.AlchemistNPCReborn.Bestiary.Explorer")
            });
        }
        ...
        {                                       //NPC names
            string Elizabeth = Language.GetTextValue("Mods.AlchemistNPCReborn.Elizabeth");
			string Dora = Language.GetTextValue("Mods.AlchemistNPCReborn.Dora");
        ...
        {                                           //npc chat
        string Entry1 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE1");
		string Entry2 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE2");
		string Entry3 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE3");
		string Entry4 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE4");
		string Entry5 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE5");
		string Entry6 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE6");
		string Entry7 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE7");
		string Entry8 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE8");
		string Entry9 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE9");
		string Entry10 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE10");
		string Entry11 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE11");
		string Entry12 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE12");
		string Entry13 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE13");
		string Entry14 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE14");
		string Entry15 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE15");
		string Entry16 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE16");
		string Entry17 = Language.GetTextValue("Mods.AlchemistNPCReborn.EntryE17");
        ...
        {
			string Create1 = Language.GetTextValue("Mods.AlchemistNPCReborn.Create1");
			string Create2 = Language.GetTextValue("Mods.AlchemistNPCReborn.Create2");
			string Create3 = Language.GetTextValue("Mods.AlchemistNPCReborn.Create3");
			string Create4 = Language.GetTextValue("Mods.AlchemistNPCReborn.Create4");
			string Create5 = Language.GetTextValue("Mods.AlchemistNPCReborn.Create5");
			string Create6 = Language.GetTextValue("Mods.AlchemistNPCReborn.Create6");
			string Create7 = Language.GetTextValue("Mods.AlchemistNPCReborn.Create7");
			string Create8 = Language.GetTextValue("Mods.AlchemistNPCReborn.Create8");
        ...
        nextSlot++;
		shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Notes.ResearchNote3>());
        nextSlot++;
		shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Notes.ResearchNote4>());
        nextSlot++;
		shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Notes.ResearchNote5>());
        nextSlot++;
		shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Notes.ResearchNote6>());
        nextSlot++;
		shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Notes.ResearchNote7>());
        nextSlot++;
		shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Notes.ResearchNote8>());
        nextSlot++;
		Player player = Main.player[Main.myPlayer];
		if (player.active)
		{
