...
namespace AlchemistNPCReborn.Projectiles
{
	public class RedWave : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			vel *= 0f;
			Projectile.NewProjectile(((Entity) this.Projectile).GetSource_FromThis((string) null),Projectile.Center.X, Projectile.Center.Y, vel.X, vel.Y, ModContent.ProjectileType<RedWaveExp>(), Projectile.damage, 0, Main.myPlayer);
		}
