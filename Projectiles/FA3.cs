...
{
	public class FA3 : ModProjectile
	{
		public static int CloudChosenType = 0;
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Flask of the Alchemist (Frost)");
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				for (int index = 0; index < num2; ++index)
				{
					...
					{
						case 0: CloudChosenType = ModContent.ProjectileType<FA31>();
						break;
						case 1: CloudChosenType = ModContent.ProjectileType<FA32>();
						break;
						case 2: CloudChosenType = ModContent.ProjectileType<FA33>();
						break;
					}
