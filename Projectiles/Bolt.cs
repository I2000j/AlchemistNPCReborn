...
//
		...
		public override void Kill(int timeLeft)
		{
			...
			Projectile.NewProjectile(((Entity) this.Projectile).GetSource_FromThis((string) null),Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<ExplosionDummyL>(), Projectile.damage+(Projectile.damage/3), Projectile.knockBack, player.whoAmI);
		}
