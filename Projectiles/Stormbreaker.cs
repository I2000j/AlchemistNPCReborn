			...
			for (int h = 0; h < 2; h++)
				{
					...
					int n1 = Projectile.NewProjectile(((Entity) this.Projectile).GetSource_FromThis((string) null),Projectile.Center.X, Projectile.Center.Y, vel1.X, vel1.Y, 580, damage/5, .5f, player.whoAmI, vel1.ToRotation(), ai);
				}
		}
	}
}
