		...
		public override void Kill(int timeLeft)
		{
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				for (int index = 0; index < num2; ++index)
				{
					...
					{
						case 0: CloudChosenType = ModContent.ProjectileType<FA11>();
						break;
						case 1: CloudChosenType = ModContent.ProjectileType<FA12>();
						break;
						case 2: CloudChosenType = ModContent.ProjectileType<FA13>();
						break;
					}
